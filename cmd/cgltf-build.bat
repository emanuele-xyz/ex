...
set SOURCES=
set SOURCES= %SOURCES% %SRC%\cgltf.c
...
set FLAGS= %FLAGS% /I %CGLTF%\include
...
set FLAGS= %FLAGS% /WX
rem ignore bytes padding added
...
if "%1" == "debug"   (set FLAGS= %FLAGS% /OUT:cgltf.dbg.lib)
if "%1" == "release" (set FLAGS= %FLAGS% /OUT:cgltf.rls.lib)
